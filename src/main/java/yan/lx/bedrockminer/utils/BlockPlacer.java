...
public class BlockPlacer {
    ...
    public static void simpleBlockPlacement(BlockPos pos, ItemConvertible item) {
        ...
        placeBlockWithoutInteractingBlock(hitResult);//TODO:晚点改
    }

    // piston placement
    // @param pos (place x,y,z
    // @param direction (place way
    ...
    private static void placeBlockWithoutInteractingBlock(BlockHitResult hitResult) {
        ...
        interactionManager.sendSequencedPacket(minecraftClient.world, sequence ->
